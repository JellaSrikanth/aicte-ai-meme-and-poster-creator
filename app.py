...
with st.sidebar:
    ...
    st.markdown("Please enter your Hugging Face API token. This is required to generate images.")
    
    # Get API Key from user
    hf_api_key = st.text_input("Hugging Face API Token", type="password", help="Get your token from hf.co/settings/tokens")
